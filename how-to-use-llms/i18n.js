(function(){
    ...
    es: {
      typewriter: {
        messages: [
          ...
          'Los modelos de pensamiento (o3, o3-pro) son para problemas difíciles. Son más lentos y caros: no los malgastes en tareas simples. Claude Opus 4.8 suele superar a o3-pro en código matizado.'
        ]
      },
      thinking: {
  ...
  const DOM_TEXT = [
    ...
    { selector: '#s-models .model-family-card:nth-of-type(1) .mf-provider', text: { en: 'OpenAI', es: 'OpenAI' } },
    { selector: '#s-models .model-family-card:nth-of-type(1) .model-chip:nth-of-type(1)', html: { en: 'GPT-5.5 <span>flagship · coding · general-purpose</span>', es: 'GPT-5.5 <span>insignia · código · uso general</span>' } },
    { selector: '#s-models .model-family-card:nth-of-type(1) .model-chip:nth-of-type(2)', html: { en: 'GPT-5.5 Pro <span>harder tasks · higher accuracy</span>', es: 'GPT-5.5 Pro <span>tareas difíciles · mayor precisión</span>' } },
    { selector: '#s-models .model-family-card:nth-of-type(1) .model-chip:nth-of-type(3)', html: { en: 'o3 / o3-pro <span>reasoning models</span>', es: 'o3 / o3-pro <span>modelos de razonamiento</span>' } },
    { selector: '#s-models .model-family-card:nth-of-type(1) .model-chip:nth-of-type(4)', html: { en: 'GPT-5 mini <span>fast · cost-efficient</span>', es: 'GPT-5 mini <span>rápido · eficiente en coste</span>' } },
    { selector: '#s-models .model-family-card:nth-of-type(2) .mf-provider', text: { en: 'Anthropic', es: 'Anthropic' } },
    { selector: '#s-models .model-family-card:nth-of-type(2) .model-chip:nth-of-type(1)', html: { en: 'Claude Opus 4.8 <span>deep reasoning</span>', es: 'Claude Opus 4.8 <span>razonamiento profundo</span>' } },
    { selector: '#s-models .model-family-card:nth-of-type(2) .model-chip:nth-of-type(2)', html: { en: 'Claude Sonnet 4.6 <span>daily driver</span>', es: 'Claude Sonnet 4.6 <span>uso diario</span>' } },
    { selector: '#s-models .model-family-card:nth-of-type(2) .model-chip:nth-of-type(3)', html: { en: 'Claude Haiku 4.5 <span>lightweight</span>', es: 'Claude Haiku 4.5 <span>ligero</span>' } },
    { selector: '#s-models .model-family-card:nth-of-type(3) .mf-provider', text: { en: 'Google', es: 'Google' } },
    { selector: '#s-models .model-family-card:nth-of-type(3) .model-chip:nth-of-type(1)', html: { en: 'Gemini 3 Pro <span>reasoning + multimodal</span>', es: 'Gemini 3 Pro <span>razonamiento + multimodal</span>' } },
    { selector: '#s-models .model-family-card:nth-of-type(3) .model-chip:nth-of-type(2)', html: { en: 'Gemini 3 Flash <span>fast · price-performance</span>', es: 'Gemini 3 Flash <span>rápido · relación precio-rendimiento</span>' } },
    { selector: '#s-models .model-family-card:nth-of-type(4) .mf-provider', text: { en: 'Chinese Frontier', es: 'Frente chino' } },
    { selector: '#s-models .model-family-card:nth-of-type(4) .model-chip:nth-of-type(1)', html: { en: 'DeepSeek V4 Pro <span>reasoning-first</span>', es: 'DeepSeek V4 Pro <span>razonamiento primero</span>' } },
    { selector: '#s-models .model-family-card:nth-of-type(4) .model-chip:nth-of-type(2)', html: { en: 'DeepSeek V4 Flash <span>fast · open API</span>', es: 'DeepSeek V4 Flash <span>rápido · API abierta</span>' } },
    { selector: '#s-models .model-family-card:nth-of-type(4) .model-chip:nth-of-type(3)', html: { en: 'Qwen3 <span>hybrid thinking · multilingual</span>', es: 'Qwen3 <span>pensamiento híbrido · multilingüe</span>' } },
    { selector: '#s-models .model-family-card:nth-of-type(4) .model-chip:nth-of-type(4)', html: { en: 'GLM-4.5 <span>agentic · long-context</span>', es: 'GLM-4.5 <span>agéntico · contexto largo</span>' } },
    { selector: '#s-models .model-family-card:nth-of-type(4) .model-chip:nth-of-type(5)', html: { en: 'Kimi K2.5 <span>agent swarm · multimodal</span>', es: 'Kimi K2.5 <span>enjambre de agentes · multimodal</span>' } },
    { selector: '#s-models .model-family-card:nth-of-type(5) .mf-provider', text: { en: 'Open-Weight', es: 'Peso abierto' } },
    { selector: '#s-models .model-family-card:nth-of-type(5) .model-chip:nth-of-type(1)', html: { en: 'Mistral Large 3 <span>open-weight · multimodal</span>', es: 'Mistral Large 3 <span>peso abierto · multimodal</span>' } },
    { selector: '#s-models .model-family-card:nth-of-type(5) .model-chip:nth-of-type(2)', html: { en: 'Mistral Medium 3.5 <span>agentic + coding</span>', es: 'Mistral Medium 3.5 <span>agéntico + código</span>' } },
    { selector: '#s-models .model-family-card:nth-of-type(6) .mf-provider', text: { en: 'Meta Llama', es: 'Meta Llama' } },
    { selector: '#s-models .model-family-card:nth-of-type(6) .model-chip:nth-of-type(1)', html: { en: 'Llama 4 Scout <span>10M context · efficient</span>', es: 'Llama 4 Scout <span>10M contexto · eficiente</span>' } },
    { selector: '#s-models .model-family-card:nth-of-type(6) .model-chip:nth-of-type(2)', html: { en: 'Llama 4 Maverick <span>multimodal · fast responses</span>', es: 'Llama 4 Maverick <span>multimodal · respuestas rápidas</span>' } },
    { selector: '#s-models .model-family-card:nth-of-type(7) .mf-provider', text: { en: 'Gemma Open', es: 'Gemma abierto' } },
    { selector: '#s-models .model-family-card:nth-of-type(7) .model-chip:nth-of-type(1)', html: { en: 'Gemma 3 27B <span>open weights · strongest class</span>', es: 'Gemma 3 27B <span>pesos abiertos · clase más fuerte</span>' } },
    { selector: '#s-models .model-family-card:nth-of-type(7) .model-chip:nth-of-type(2)', html: { en: 'Gemma 3 12B <span>balanced · multimodal</span>', es: 'Gemma 3 12B <span>equilibrado · multimodal</span>' } },
    ...
    { selector: '#s-models .app-card:nth-child(2) .ac-desc', text: { en: 'Exceptional at coding and document analysis. Powers Cursor (Claude Opus 4.8). Strong nuanced reasoning.', es: 'Excepcional en programación y análisis de documentos. Impulsa Cursor (Claude Opus 4.8). Fuerte en razonamiento matizado.' } },
    { selector: '#s-models .app-card:nth-child(3) .ac-desc', text: { en: 'Google\'s entrant. Gemini 3 Pro preview available. Deep integration with Google Workspace. Strong multimodal capabilities.', es: 'La apuesta de Google. Disponible Gemini 3 Pro preview. Integración profunda con Google Workspace. Fuerte en capacidades multimodales.' } },
    ...
    { selector: '#s-thinking .body-text:nth-of-type(1)', html: { en: 'OpenAI\'s <span class="highlight">o3 and o3-pro</span> are a different breed — all model names starting with "o" are thinking models. Before returning an answer, they run an extended internal monologue: exploring approaches, backtracking, trying alternatives.', es: 'Los <span class="highlight">o3 y o3-pro</span> de OpenAI son otra especie: todos los modelos que empiezan por "o" son modelos de pensamiento. Antes de responder, ejecutan un monólogo interno extendido: exploran enfoques, retroceden y prueban alternativas.' } },
    ...
    { selector: '#s-thinking .body-text:nth-of-type(3)', html: { en: 'Karpathy noted that Claude Opus 4.8 (non-thinking) solved a hard coding problem that o3-pro could not. Model selection isn\'t always obvious — the right tool depends on the specific task.', es: 'Karpathy señaló que Claude Opus 4.8 (no thinking) resolvió un problema de programación difícil que o3-pro no pudo. Elegir modelo no siempre es obvio: la herramienta adecuada depende de la tarea concreta.' } },
    ...
    { selector: '#s-thinking .thinking-badge', text: { en: 'o3-pro · Extended Thinking', es: 'o3-pro · Pensamiento extendido' } },
    ...
    { selector: '#s-voice .chapter-badge', html: { en: 'Chapter 9 · Multimodal <span class="updated-badge">Updated 2026</span>', es: 'Capítulo 9 · Multimodal <span class="updated-badge">Actualizado 2026</span>' } },
    ...
    { selector: '#s-voice .body-text:nth-of-type(2)', html: { en: '<span class="highlight">Voice is now a three-layer stack</span>: capture/transcribe, synthesis, and native speech-to-speech. In practice that means tools like <span class="highlight">ElevenLabs</span> for expressive TTS and cloning, <span class="highlight">Xiaomi MiMo-V2.5 TTS</span> for speech synthesis and voice design, and <span class="highlight">OpenAI gpt-realtime</span> for low-latency conversational voice agents.', es: '<span class="highlight">La voz es ahora una pila de tres capas</span>: captura/transcripción, síntesis y voz nativa de voz a voz. En la práctica eso significa herramientas como <span class="highlight">ElevenLabs</span> para TTS expresivo y clonación, <span class="highlight">Xiaomi MiMo-V2.5 TTS</span> para síntesis de voz y diseño de voces, y <span class="highlight">OpenAI gpt-realtime</span> para agentes de voz conversacionales de baja latencia.' } },
    ...
    { selector: '#s-resources .resource-card:nth-child(2) .rcard-desc', text: { en: 'Exceptional at coding and document analysis. Powers Cursor (Claude Opus 4.8). Strong nuanced reasoning.', es: 'Excepcional en programación y análisis de documentos. Impulsa Cursor (Claude Opus 4.8). Fuerte en razonamiento matizado.' } },
    { selector: '#s-resources .resource-card:nth-child(3) .rcard-desc', text: { en: 'Google\'s LLM app. Gemini 3 Pro preview. Deep Google Workspace integration and strong multimodal.', es: 'La app de LLM de Google. Gemini 3 Pro preview. Integración profunda con Google Workspace y gran fortaleza multimodal.' } },
    ...
    { selector: '#s-resources .resource-card:nth-child(7) .rcard-desc', text: { en: 'Karpathy\'s coding IDE of choice. Agentic Composer mode (⌘I) runs Claude Opus 4.8 across your entire codebase autonomously.', es: 'El IDE de programación favorito de Karpathy. El modo agente Composer (⌘I) ejecuta Claude Opus 4.8 sobre todo tu código de forma autónoma.' } },
    ...
    { selector: '#s-summary .ps-desc:nth-of-type(2)', text: { en: 'Free → limited. $20/mo → GPT-5.5 / Claude Opus 4.8. $200/mo → o3-pro, Deep Research. Match the model to the task — thinking models for hard reasoning, fast models for simple queries. For open-weight and Chinese alternatives, check DeepSeek-V4, Qwen3, GLM-4.5, Kimi K2.5, Mistral Large 3, Llama 4 Scout/Maverick, and Gemma 3.', es: 'Gratis → limitado. 20 $/mes → GPT-5.5 / Claude Opus 4.8. 200 $/mes → o3-pro, Deep Research. Ajusta el modelo a la tarea: modelos de pensamiento para razonamiento duro y modelos rápidos para consultas simples. Para alternativas de peso abierto y chinas, mira DeepSeek-V4, Qwen3, GLM-4.5, Kimi K2.5, Mistral Large 3, Llama 4 Scout/Maverick y Gemma 3.' } },
    ...
    { selector: '#s-summary .ps-desc:nth-of-type(6)', text: { en: 'A Whisper-based dictation tool eliminates the typing barrier. Karpathy routes ~50% of queries through voice. Use text for technical product names and library names that Whisper mistranscribes. For synthesis and voice agents, the current stack includes ElevenLabs, Xiaomi MiMo-V2.5 TTS, and OpenAI gpt-realtime.', es: 'Una herramienta de dictado basada en Whisper elimina la barrera de teclear. Karpathy canaliza alrededor del 50% de sus consultas por voz. Usa texto para nombres técnicos de productos y librerías que Whisper suele transcribir mal. Para síntesis y agentes de voz, la pila actual incluye ElevenLabs, Xiaomi MiMo-V2.5 TTS y OpenAI gpt-realtime.' } },
  ...
  function applyStaticText() {
    ...
    const resourceCopy = locale === 'es'
      ? [
          ...
          'Excepcional en programación y análisis de documentos. Impulsa Cursor (Claude Opus 4.8). Fuerte en razonamiento matizado.',
          'La app de LLM de Google. Gemini 3 Pro preview. Integración profunda con Google Workspace y gran fortaleza multimodal.',
          ...
          'El IDE de programación favorito de Karpathy. El modo agente Composer (⌘I) ejecuta Claude Opus 4.8 sobre todo tu código de forma autónoma.',
      ...
      : [
          ...
          'Exceptional at coding and document analysis. Powers Cursor (Claude Opus 4.8). Strong nuanced reasoning.',
          'Google\'s LLM app. Gemini 3 Pro preview. Deep Google Workspace integration and strong multimodal.',
          ...
          'Karpathy\'s coding IDE of choice. Agentic Composer mode (⌘I) runs Claude Opus 4.8 across your entire codebase autonomously.',
    ...
    const voiceNamesCopy = ['Super Whisper', 'ElevenLabs', 'Xiaomi MiMo TTS', 'OpenAI Realtime'];
    const voiceTagsCopy = locale === 'es'
      ? ['La favorita de Karpathy · Mac', 'TTS · Diseño de voz', 'TTS · Pila de voz', 'Voz a voz']
      : ["Karpathy's pick · Mac", 'TTS · Voice design', 'TTS · Voice stack', 'Speech-to-speech'];
    const voiceDescsCopy = locale === 'es'
      ? [
          ...
          'Síntesis de voz expresiva, clonación de voz y voces de personaje de alta calidad.',
          'Síntesis de voz, diseño de voces y soporte multilingüe para flujos de agentes.',
      ...
      : [
          ...
          'Expressive speech synthesis, voice cloning, and high-quality character voices.',
          'Speech synthesis, voice design, and multilingual support for agent workflows.',
    ...
    const summaryDescCopy = locale === 'es'
      ? [
          ...
          'Gratis → limitado. 20 $/mes → GPT-5.5 / Claude Opus 4.8. 200 $/mes → o3-pro, Deep Research. Ajusta el modelo a la tarea: modelos de pensamiento para razonamiento duro y modelos rápidos para consultas simples. Para alternativas de peso abierto y chinas, mira DeepSeek-V4, Qwen3, GLM-4.5, Kimi K2.5 y Mistral Large 3.',
      ...
      : [
          ...
          'Free → limited. $20/mo → GPT-5.5 / Claude Opus 4.8. $200/mo → o3-pro, Deep Research. Match the model to the task — thinking models for hard reasoning, fast models for simple queries. For open-weight and Chinese alternatives, check DeepSeek-V4, Qwen3, GLM-4.5, Kimi K2.5, Mistral Large 3, Llama 4 Scout/Maverick, and Gemma 3.',
